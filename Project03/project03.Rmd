...
def GibbsMotifFinder (seqs, k, seed=42):
    ...
    while ((j < 10000) and (counter_ic < 100)): 
      ...
      weights = convert_exp(poss_motif_scores) 
      
      rand_index = choose_motif(poss_motifs, weights) # probabilistic motif selection
      ...
      if (fuzzy_diff (current_ic,old_ic, 0.0025)):  #if the difference is minimal, add 1 to counter
        counter_ic += 1
      else:
        counter_ic = 0
